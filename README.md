...
**Account-Tracker**  Permite a los usuarios agregar, visualizar y eliminar transacciones de ingresos y gastos, manteniendo un historial detallado de las operaciones y calculando automáticamente el balance total. Además, la aplicación incluye una gráfica de torta que muestra el porcentaje de ingresos y gastos para una mejor comprensión visual de tus finanzas.
